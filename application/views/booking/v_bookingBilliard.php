...
<body>
    <div id="formBox">
        <div id="slideshowBilliard">
            <img src="<?= base_url('assets/images/bookBill1.jpg') ?>" id="image" width="70%">
        </div>
    ...
    <script>    
        let gambar = [
            "<?= base_url('assets/images/bookBill1.jpg') ?>",
            "<?= base_url('assets/images/bookBill2.jpg') ?>",
            "<?= base_url('assets/images/bookBill3.jpg') ?>",
            "<?= base_url('assets/images/bookBill4.jpg') ?>",
            "<?= base_url('assets/images/bookBill5.jpg') ?>"
        ];
        let index = 0;
