...
<head>
    ...
    <style>
        ...
        .hero-section {
            height: 100vh;
            background: url('asset/ping\ pong4.jpg') center center / cover no-repeat;
            display: flex;
            align-items: center;
